...
ggplot(stat216, mapping = aes(x = curric, y = GPAgrade)) + geom_violin()
...
get_p_value(permute, diff_mean, direction = "two_sided")

## P-value for a one-sided (TEAL > Lock) test  
get_p_value(permute, diff_mean, direction = "greater")
